...
local Utility = {}
local Objects = {}
function smile:DraggingEnabled(frame, parent)
...
local themeStyles = {
    Smile = {
        ...
        TextColor = Color3.fromRGB(255, 235, 42),
...
function smile.CreateLib(kavName, themeList)
    ...
    smile:DraggingEnabled(MainHeader, Main)
    ...
    function smile:ChangeColor(prope,color)
